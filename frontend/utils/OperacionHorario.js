/**
 * Utilidad para manejar el horario de operación personalizado en el frontend
...
class OperacionHorario {
     ...
     */
    filtrarPedidosDiaOperacion(pedidos) {
        const rango = this.obtenerRangoDiaOperacion();
        return pedidos.filter(pedido => {
            const fechaPedido = new Date(pedido.fecha);
            return fechaPedido >= rango.inicio && fechaPedido <= rango.fin;
        });
    }
     ...
     */
    obtenerEstadisticasDiaOperacion(pedidos) {
        const pedidosDiaOperacion = this.filtrarPedidosDiaOperacion(pedidos);
        ...
        return {
            ...
            infoHorario: this.obtenerInfoDebug()
        };
    }
}

// Exportar para uso global
window.OperacionHorario = OperacionHorario;
